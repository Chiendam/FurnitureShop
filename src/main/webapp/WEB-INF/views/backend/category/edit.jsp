                        ...
                        <div class="card">
                            <div class="card-body">
                                <div style="padding-left: 100px">
                                    <form:form id="formAddUser" method="post" action="/admin/category/edit/${id}" modelAttribute="category">
                                        <div class="form-group row">
                                            <label class="col-lg-2 col-form-label" for="name">Họ và tên<span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-2 col-form-label" for="description">Số điện thoại<span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
