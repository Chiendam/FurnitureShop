...
<%
    ...
    String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + path + "/admin/user";
%>
<!DOCTYPE html>
<html lang="en">
<html>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div style="float: left">
                                    <a type="button" id="btnShowAdd" class="btn btn-success" href="<%=basePath%>/create" style="color: white; margin-bottom: 20px;" title="sửa thông tin người dùng">Thêm mới</a>
                                </div>
                                <div style="float: right" class="list-unstyled topnav-menu topnav-menu-left m-0">
                                    <div class="d-none d-lg-block">
                                    <form class="app-search" method="get" action="/admin/user/">
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${user.role == 2}">
                                                        <span class="badge badge-success" style="padding: 10px; border-radius: 3em;">Quản trị viên</span>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <span class="badge badge-primary" style="padding: 10px; border-radius: 3em;">Khách hàng</span>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
                                            <td style="text-align: center">
                                                <a type="button" class="btn btn-success" href="<%=basePath%>/edit/${user.id}" style="color: white" title="sửa thông tin người dùng"><i class="ion ion-md-create"></i></a>
                                                <a type="button" class="btn btn-danger" href="<%=basePath%>/delete/${user.id}" style="color: white" title="Xóa thông tin khoa" onclick="return confirm('Bạn có chắc chắn muỗn xóa? Dữ liệu đã xóa không thể khôi phục!')"><i class="ion ion-md-trash"></i></a>
                                                <a type="button" class="btn btn-info " style="color: white" title="reset mật khẩu"><i class="ion ion-md-refresh"></i></a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                        </tbody>
