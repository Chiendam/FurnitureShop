                        ...
                        <div class="page-title-box">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb p-0 m-0">
                                    <li class="breadcrumb-item"><a href="<%=basePath%>/user/">Trang chủ</a></li>
                                    <li class="breadcrumb-item"><a href="<%=basePath%>/user/">Quản lý người dùng</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div style="padding-left: 100px">
                                    <form:form id="formAddUser" method="post" action="/admin/user/edit/${id}" modelAttribute="user">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-2 col-form-label" for="addRole">Nhóm người dùng<span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                                    <select class="js-example-basic-single form-control select2-input" path="role" id="addRole"  name="role">
                                                        <option value="1" ${roleId == 1 ? 'selected="selected"' : '' }>Khách hàng</option>
                                                        <option value="2" ${roleId == 2 ? 'selected="selected"' : '' }>Quản trị viên</option>
                                                    </select>
