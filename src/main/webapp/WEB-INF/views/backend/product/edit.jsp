                        ...
                        <div class="card">
                            <div class="card-body">
                                <div style="padding-left: 100px">
                                    <form:form id="formAddProduct" method="post" enctype="multipart/form-data" action="/admin/product/edit/${id}" modelAttribute="product">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="file" id="image" name="image" class="form-control" onchange="showImage(this)"/>
                                                <img src="<%=addressImage%>${imgPoster}" style="width: 200px;" id="imgPoster">
